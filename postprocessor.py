...
class PostProcessor:
    def __init__(
            ...
            longTermCache=False, totalEntries=None
    ):
        ...
        self.totalEntries = totalEntries if totalEntries else 9223372036854775807
        self.totalEntries = self.totalEntries if self.totalEntries > 0 else 9223372036854775807
    ...
    def run(self):
        ...
        for fname in self.inputFiles:
            ...
            nEntries = min(inTree.GetEntries() -
                           self.firstEntry, self.maxEntries, remainingEntries)
