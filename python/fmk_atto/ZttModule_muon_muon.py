...
#					if GoodMuon_pt2 > 0: HaveTwoGoodMuon = True
	...
	if HaveGoodTau == False and HaveGoodTP == False:
		return False
#	if HaveGoodTP==False: return False
	...
	if HaveGoodTau and pzetaTau:
		ZInvarMassVTau = self.ZInvarMass(GoodMuon, GoodTau,sf_roc)
	if HaveGoodTP and pzetaTP:
		ZInvarMassVTP =  self.ZInvarMass(GoodMuon, GoodTwoProng,sf_roc)
        else: hem_sf = 1
...
#	else: self.out.fillBranch("GMCTC",0)
	...
	if HaveGoodTP and HaveGoodTau and pzetaTau and pzetaTP:
